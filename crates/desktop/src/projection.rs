//! Desktop product projection: pure state derivation from hydrated snapshots
//! and ProductEvents, with no raw diff parsing or terminal inference.
...
use coding_agent::api::client::{
    ...
    CodingAgentClientProjectionLifecycle, CodingAgentClientRecovery,
    CodingAgentClientRecoveryStatus, CodingAgentSnapshot, CodingAgentSnapshotCursor,
};
...
use crate::ui::conversation::model::ConversationProjection;
