...
pub use protocol::{
    ...
    DesktopRecoveryAction, DesktopRecoveryIdentity, DesktopRuntimeCommandKind, DesktopRuntimeError,
    DesktopRuntimeHydratedSnapshot, DesktopRuntimeMetadataSnapshot, DesktopRuntimeOwnerTarget,
    DesktopRuntimeReadySnapshot, DesktopRuntimeRecoverySnapshot, DesktopRuntimeResyncSnapshot,
    ...
    MAX_PROMPT_ATTACHMENTS, MAX_WORKSPACE_PATH_BYTES, validate_prompt_attachments,
};
#[allow(unused_imports)]
