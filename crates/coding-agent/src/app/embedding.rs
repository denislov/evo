...
use crate::platform::time::new_session_id;
use crate::profiles::{
...
use crate::runtime::facade::{
    ...
    CodingAgentPublicDiagnosticSeverity, CodingAgentPublicError, CodingSessionError,
};
use crate::workspace::{
...
#[cfg(test)]
use catalog::thinking_capability;
use catalog::{
    build_snapshot, default_thinking_level, resolve_model, skill_resource_command, validate_profile,
};
pub(crate) use catalog::{
    embedding_diagnostic_from_application, model_catalog_entry, model_from_catalog_entry,
