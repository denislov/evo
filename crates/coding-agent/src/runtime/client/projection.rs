...
use crate::runtime::facade::context::{
    CodingAgentRecoveryPending, CodingAgentSessionTranscriptItem,
    CodingAgentTranscriptContinuation, CodingAgentTranscriptSnapshot,
};
...
mod state;
pub use state::CodingAgentClientTranscript;
...
fn project_transcript(
    ...
    let CodingAgentTranscriptSnapshot {
        session_id,
        active_leaf_id,
        items,
        omitted_items,
