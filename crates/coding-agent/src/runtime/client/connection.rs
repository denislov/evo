...
impl CodingAgentClientConnection {
    ...
    pub(crate) fn bind_operation_cancellation(
        &self,
        operation_id: String,
        cancellation: crate::runtime::operation::control::OperationCancellationHandle,
    ) {
        self.coordinator
        ...
        self.coordinator
            .set_prompt_draft(
                ...
                Some(DraftRecord {
                    ...
                    fingerprint:
                        crate::runtime::operation::contract::prompt_text_submission_fingerprint(
                            &text,
                        ),
                    text,
                }),
    ...
    pub(crate) fn prepare_client_submission_internal(
        ...
        let expected_prompt_draft = match (
            ...
            (crate::runtime::operation::control::OperationKind::Prompt, None, _) => {
                return Err(CodingSessionError::Input {
                    message: "prompt submission requires a client draft".into(),
                });
            }
            (crate::runtime::operation::control::OperationKind::Prompt, Some(_), None) => {
                return Err(CodingSessionError::Input {
