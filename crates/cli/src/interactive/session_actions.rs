...
#[cfg(test)]
mod hydration_tests {
    use coding_agent::api::event::CodingAgentImageContent;
    use coding_agent::api::view::{CodingAgentSessionTranscriptItem, ProfileId, ProfileKind};

    use super::{TranscriptItem, transcript_items_from_rust_native};
