...
use crate::interactive::slash::{ParsedSlashCommand, help_text};
...
use settings::{
    handle_changelog_command, handle_hotkeys_command, handle_login_command, handle_logout_command,
    handle_model_command, handle_name_command, handle_permission_command, handle_resume_command,
    handle_session_command, handle_settings_command,
};
